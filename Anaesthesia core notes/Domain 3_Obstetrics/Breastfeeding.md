...
### Volatiles
- **All volatile agents:** Safe
- **N₂O:** Can cause 1st trimester pregnancy loss

### Opioids
- **Fentanyl:** Uncertain for repeated boluses; patches and chronic use not recommended
- **Morphine:** Single dose has minimal effects; chronic use will accumulate
- **Hydromorphone:** Use with caution
- **Hydrocodone:** Not safe
- **Remifentanil:** Safe
- **Pethidine:** Avoid
- **Codeine:** Avoid
- **Oxycodone:** Avoid
...
### Benzodiazepines
- **Diazepam:** Avoid (Low APGARS)
- **Lorazepam:** Avoid
- **Midazolam:** Safe

### NSAIDs
- **Safe:** Use those with short half-lives (e.g., Ibuprofen)
- **Paracetamol:** Safe
- **Aspirin:** Safe
...
### Reversal Agents
- **Neostigmine:** Safe (chronic use, such as in myasthenia, is a problem)
...
- **Dexamethasone:** Safe
- **Ondansetron:** Safe
- **Metoclopramide:** Safe (promotes milk production)

### Local Anaesthetics
- **Epidurals:** Associated with improved breastfeeding and infant weight gain
- **All agents:** Considered safe

| Category                | A                                              | B1                                       | B2                                              | B3                   | C                                     | D                                    |
|-------------------------|------------------------------------------------|------------------------------------------|------------------------------------------------|----------------------|---------------------------------------|---------------------------------------|
| **Volatile and N₂O**    | Halothane, Nitrous oxide                       | Sevoflurane                              | Isoflurane                                     | Desflurane           | Methoxyflurane                        | -                                    |
...
| **CVS drugs**           | Atropine, Ephedrine                            | Dexmedetomidine                          | Glycopyrrolate, Phenylephrine, Clonidine       | -                    | Metaraminol, Metoprolol, Esmolol      | ACE inhibitors                        |
| **Antibiotics**         | Penicillin, Cephalexin, Cephalothin, Erythromycin, Lincomycin, Cefazolin, Cefotaxime, Cefotetan, Ceftriaxone, Ceftazidime, Cefaclor | Cefoxitin                                 | Cefodizime, Vancomycin                      | -                    | Aciclovir                              | Gentamicin                            |
| **Others**              | Hydrocortisone, Dexamethasone                  | Ranitidine, Cimetidine, Clopidogrel      | Flumazenil, Promethazine                       | Midazolam, Baclofen  | -                                     | Phenytoin, Carbamazepine, Valproate, Warfarin, Retinoid, Lithium, Danazol, Heparin |
